...
public class commit
{
	...
	public static void main(String[] args) throws IOException
	{
		...
		try
		{
			br1 =  new BufferedReader(new FileReader(directory + "//commits.csv"));
		...
		PrintStream myconsole = new PrintStream(new File(directory + "commit_network.net"));
    	...
    	int common=0;	
       			...
       			for(int b=0; b<states.length; b++)
       			{
	       			...
	       			for(int c=0; c<count;c++) 
	       			{
	       				...
	       				if(Integer.parseInt(data[1])==states[b])   
	       				{
	       					repo[c]=Integer.parseInt(data[2]);
	       			...
	       			for(int d=0; d<states.length; d++)
	       			{
	       				if(states[d]!=vert1)
	       				{
		       				for(int c=0; c<count;c++) 
			       			{
			       				...
			       				{
			       					repo2[c]=Integer.parseInt(data[2]);  
			       				}	
			       			}
